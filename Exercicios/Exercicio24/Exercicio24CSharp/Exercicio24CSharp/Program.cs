...
namespace Exercicio24CSharp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            double valor = 100 * double.Parse(Console.ReadLine(), CultureInfo.InvariantCulture);

            double nota100, nota50, nota20, nota10, nota5, nota2, moeda1, moeda50Cent,
